...
export type PlexusAccessor<T> = T extends Watchable<infer U>
  ? Accessor<U>
  : Accessor<never>
...
export function useOnePlexus<V extends Watchable>(
  dep: V
): Accessor<PlexusValue<V>> {
...
export function usePlexus<V extends Watchable[]>(
  deps: V | []
): PlexusAccessorArray<V>

export function usePlexus<V extends Watchable[]>(
  deps: V | [] | Watchable
): Accessor<PlexusValue<V>> | PlexusAccessorArray<V> {
