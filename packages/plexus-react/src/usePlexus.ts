...
export type PlexusValueArray<T> = {
	[K in keyof T]: T[K] extends PlexusStateInstance<infer U> ? U
	: T[K] extends PlexusCollectionGroup<infer U> ? U[]
	: never
};
...
export function usePlexus<Value extends PlexusStateInstance<any>|PlexusCollectionGroup<any>>(deps: Value): PlexusValue<Value>

export function usePlexus<Value extends PlexusStateInstance<any>[]|PlexusCollectionGroup<any>[]>(deps: Value): PlexusValueArray<Value>
