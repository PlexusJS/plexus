...
export const CollapseContainer = ({ title, data = [], miniTitle, showingReturnType = false }: Props) => {
	return (
		<>
			...
			<div className="rounded-t-lg rounded-b-md  overflow-hidden flex flex-col bg-slate-800 mb-5">
				...
				<div className="py-4 px-4">
					<ul>
						{data.map((item, index) => (
							<li key={`c_${index}`} className="hover:bg-slate-600 rounded-md px-3 py-2 transition-all duration-200">
								<mark>
