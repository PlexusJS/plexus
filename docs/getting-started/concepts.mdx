...
<ul>
	<li>
		<code>Constructor Function (CF):</code> The <mark>functions you import</mark> from our package. You use these to{" "}
		<mark>
	...
	<li>
		<code>Instance:</code> Something that is <mark>connected to the plexus "network"</mark>.
	</li>
	<li>
