...
- [Collection](#Collection)
  ...
  - [.instanceId](#Collection+instanceId) : <code>string</code>
  - [.value](#Collection+value) : <code>Array.&lt;DataType&gt;</code>
  - [.keys](#Collection+keys) : <code>Array.&lt;string&gt;</code> \| <code>Array.&lt;number&gt;</code>
  - [.groups](#Collection+groups) : <code>Record.&lt;string, GroupInstance&gt;</code>
  - [.groupsValue](#Collection+groupsValue) : <code>Record.&lt;GroupNames, Array.&lt;DataType&gt;&gt;</code>
  - [.selectors](#Collection+selectors) : <code>Record.&lt;SelectorNames, PlexusCollectionSelector&gt;</code>
  - [.selectorsValue](#Collection+selectorsValue) : <code>Record.&lt;SelectorNames, Array.&lt;DataType&gt;&gt;</code>
  - [.name](#Collection+name) : <code>string</code>
  - [.lastUpdatedKey](#Collection+lastUpdatedKey) : <code>string</code> \| <code>number</code>
  - [.collect(data, groups)](#Collection+collect) ⇒ <code>this</code>
  - [.update(key, data, config)](#Collection+update)
  - [.getItem(dataKey)](#Collection+getItem) ⇒ <code>this</code>
  - [.getItemValue(key)](#Collection+getItemValue) ⇒ <code>DataType</code>
  - [.createSelector(selectorName)](#Collection+createSelector) ⇒ <code>this</code>
  - [.createSelectors(selectorNames)](#Collection+createSelectors) ⇒ <code>this</code>
  - [.getSelector(name)](#Collection+getSelector) ⇒ <code>this</code> \| <code>undefined</code>
  - [.createGroup(groupName, config)](#Collection+createGroup) ⇒ <code>this</code>
  - [.createGroups(groupNamesThe)](#Collection+createGroups) ⇒ <code>this</code>
  - [.getGroup(name)](#Collection+getGroup) ⇒ <code>this</code>
  - [.getGroupsOf(key)](#Collection+getGroupsOf) ⇒ <code>Array.&lt;string&gt;</code>
  - [.addToGroups(key, groups)](#Collection+addToGroups) ⇒ <code>this</code>
  - [.delete(keys)](#Collection+delete) ⇒ <code>this</code>
  - [.removeFromGroup(keys, groups)](#Collection+removeFromGroup) ⇒ <code>this</code>
  - [.clear(groupNames)](#Collection+clear) ⇒ <code>this</code>
  - [.compute(fn)](#Collection+compute) ⇒ <code>this</code>
  - [.reCompute(ids)](#Collection+reCompute) ⇒ <code>this</code>
  - [.reComputeGroups(groupNames)](#Collection+reComputeGroups) ⇒ <code>this</code>
  - [.key(key)](#Collection+key) ⇒ <code>this</code>
...
<a name='Collection+groupsValue'></a>

### .groupsValue : <code>Record.&lt;GroupNames, Array.&lt;DataType&gt;&gt;</code>

<p>Get all the groups and their children's data values as an object</p>

<a name='Collection+selectors'></a>
...
<a name='Collection+selectorsValue'></a>

### .selectorsValue : <code>Record.&lt;SelectorNames, Array.&lt;DataType&gt;&gt;</code>
...
<a name='Collection+lastUpdatedKey'></a>

### .lastUpdatedKey : <code>string</code> \| <code>number</code>
...
<p>
	Collect An item of data (or many items of data using an array) into the
	collection.
</p>
...
<p>
	Update the collection with data; This is like collect but will not add new
	items, and can can be used to patch existing items
</p>
...
<a name='Collection+getItemValue'></a>

### .getItemValue(key) ⇒ <code>DataType</code>
...
<a name='Collection+createSelector'></a>
...
<a name='Collection+createSelectors'></a>
...
<a name='Collection+getSelector'></a>
...
<a name='Collection+createGroup'></a>
...
<a name='Collection+createGroups'></a>
...
<a name='Collection+getGroupsOf'></a>
...
<a name='Collection+addToGroups'></a>
...
<a name='Collection+removeFromGroup'></a>
...
<a name='Collection+compute'></a>

### .compute(fn) ⇒ <code>this</code>

<p>
	Run this function when data is collected to format it in a particular way;
	useful for converting one datatype into another
</p>
...
<a name='Collection+reCompute'></a>

### .reCompute(ids) ⇒ <code>this</code>

<p>
	Re-runs the compute function on select IDs (or all the collection if none
	provided)
</p>
...
<a name='Collection+reComputeGroups'></a>
