...
**Returns**: <code>Array.&lt;string&gt;</code> \| <code>Array.&lt;number&gt;</code> - <p>The collection data values as an array</p>  
...
| Param | Description |
| --- | --- |
| data | <p>Object[] | Object ::</p> |
| groups | <p>string | string[] :: The groups to add the items to</p> |
