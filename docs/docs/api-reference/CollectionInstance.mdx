...
- [CollectionInstance](#CollectionInstance)
  ...
  - [.keys](#CollectionInstance+keys) : <code>Array.&lt;string&gt;</code>
  ...
  - [.size](#CollectionInstance+size) : <code>number</code>
  - [.collect(data, groups)](#CollectionInstance+collect) ⇒ <code>this</code>
  - [.update(key, data, config)](#CollectionInstance+update)
  - [.has(dataKey, includeProvisional)](#CollectionInstance+has) ⇒ <code>boolean</code>
  ...
  - [.createSelector(selectorName, defaultPk)](#CollectionInstance+createSelector) ⇒ <code>this</code>
  ...
  - ~~[.addToGroup(key, groups)](#CollectionInstance+addToGroup) ⇒ <code>this</code>~~
  ...
  - [.removeFromGroups(keys, groups)](#CollectionInstance+removeFromGroups) ⇒ <code>this</code>
...
<p>Set the name of the collection for enhanced internal tracking</p>

| Param | Type                | Description                              |
| ----- | ------------------- | ---------------------------------------- |
| name  | <code>string</code> | <p>The key to use for the collection</p> |
...
<a name='CollectionInstance+size'></a>
...
### .has(dataKey, includeProvisional) ⇒ <code>boolean</code>
...
| includeProvisional | <code>boolean</code> | <p>Whether to include provisional data items in the search. This may be useful if you are using a collection to store data that is not yet available</p> |
...
| Param   | Type                | Description                            |
| ------- | ------------------- | -------------------------------------- |
| dataKey | <code>string</code> | <p>The key of the data item to get</p> |
...
| Param | Type                | Description                       |
| ----- | ------------------- | --------------------------------- |
| key   | <code>string</code> | <p>The key of the item to get</p> |

<a name='CollectionInstance+createSelector'></a>

### .createSelector(selectorName, defaultPk) ⇒ <code>this</code>
...
| defaultPk    | <code>string</code> | <p>The default primaryKey to select</p> |
...
<a name='CollectionInstance+addToGroup'></a>

### ~~.addToGroup(key, groups) ⇒ <code>this</code>~~

**_Deprecated_**

<p>[DEPRECATED] Add a data item to a group or groups</p>

**Returns**: <code>this</code> <p>The new Collection Instance</p>

| Param  | Type                                                     | Description                            |
| ------ | -------------------------------------------------------- | -------------------------------------- |
| key    | <code>string</code>                                      | <p>The key of the item to add</p>      |
...
| Param | Type                | Description                              |
| ----- | ------------------- | ---------------------------------------- |
| keys  | <code>string</code> | <p>The data key(s) to use for lookup</p> |
...
<p>[DEPRECATED] Remove a data item from a set of groups</p>

**Returns**: <code>this</code> <p>The new Collection Instance</p>

| Param  | Type                                                     | Description                                                                |
| ------ | -------------------------------------------------------- | -------------------------------------------------------------------------- |
| keys   | <code>string</code> \| <code>Array.&lt;string&gt;</code> | <p>The data key(s) to use for lookup</p>                                   |
| groups | <code>Array.&lt;string&gt;</code> \| <code>string</code> | <p>Either a single group or an array of groups to remove the data from</p> |

<a name='CollectionInstance+removeFromGroups'></a>

### .removeFromGroups(keys, groups) ⇒ <code>this</code>
