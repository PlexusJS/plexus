...
<CollapseContainer
	miniTitle='Returns'
	data={[{ type: 'any', description: 'The value (reactive) of the state.' }]}
/>
...
<CollapseContainer
	miniTitle='Returns'
	data={[
		{ type: 'any', description: 'The previous value (reactive) of the state.' },
	]}
/>
...
<CollapseContainer
	miniTitle='Returns'
	data={[{ type: 'any', description: 'The next value of the state.' }]}
/>
...
<CollapseContainer
	miniTitle='Returns'
	data={[
		{ type: 'any', description: 'The initial (default) value of the state.' },
	]}
/>
	...
	data={[
		{
			key: 'initialValue',
			type: 'any',
			description: 'The new value of the state.',
		},
	]}
/>
<CollapseContainer
	miniTitle='Returns'
	data={[{ type: 'this', description: 'This state.' }]}
/>
	...
	data={[
		{
			...
			description: 'The the value to patch over the current value.',
		},
	]}
/>
<CollapseContainer
	...
	data={[
		{
			key: 'callback',
			type: 'any',
			description: 'The callback to run when the state changes.',
		},
	]}
/>
<CollapseContainer
	...
	data={[
		{
			type: '() => void',
			description: 'The remove function to stop watching.',
		},
	]}
/>
...
<CollapseContainer
	title='Arguments'
	data={[
		{ key: 'key', type: 'string', description: 'The storage prefix to use.' },
	]}
/>
<CollapseContainer
	miniTitle='Returns'
	...
	data={[
		{
			key: 'name',
			type: 'string',
			description: 'Set the key of the state for internal tracking.',
		},
	]}
/>
